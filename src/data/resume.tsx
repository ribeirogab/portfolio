...
export const DATA = {
  ...
  avatarUrl: "/me.jpeg",
  gallery: [
    { src: "/gallery/insta1.jpg", alt: "Vulcão" },
    { src: "/gallery/insta2.jpg", alt: "Praia" },
    { src: "/gallery/insta3.jpg", alt: "Neve" },
    { src: "/gallery/insta4.jpg", alt: "Casal" },
    { src: "/gallery/insta5.jpg", alt: "Setup" },
  ],
  skills: [
